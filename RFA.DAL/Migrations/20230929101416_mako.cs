        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegistrationInfoId = table.Column<int>(type: "int", nullable: true),
                    ParticipationFee = table.Column<int>(type: "int", nullable: true),
                    GalaFee = table.Column<int>(type: "int", nullable: true),
                    AccommodationFee = table.Column<int>(type: "int", nullable: true),
                    CourseFee = table.Column<int>(type: "int", nullable: true),
